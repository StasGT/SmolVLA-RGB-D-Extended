...
def record_loop(
    ...
    while timestamp < control_time_s:
        ...
        if dataset is not None:
            ...
            #print(dataset.features['observation.images.top'])
            dataset.features['observation.depth'] = {'dtype': 'depth', 'shape': (480, 640, 3), 'names': ['height', 'width', 'channels']}
            #print(dataset.features.keys())
            #print(dataset.features['observation.depth'].keys())
...
def record(
    ...
    #if 'use_depth=True' in str(cfg.robot.cameras.values()):
    #    cfg.robot.cameras['observation.depth'] = {'dtype': 'depth', 'shape': (480, 640, 3), 'names': ['height', 'width', 'channels']}
    #print(cfg , 'use_depth=True')
