...
from depth_extention import vit_d_ext
...
class VLAFlowMatching(nn.Module):
    ...
    def embed_prefix(
        ...
        for _img_idx, (
            ...
            #print(img.shape, "Depth" if img.shape[1] == 1 else "RGB")
            ...
            if img.shape[1] == 3:
                ...
                if img[ :, :, 511, 511].mean().item() == -1.:
                    top = img_emb.clone()
                    continue
                #print("Image ebedd dim:", img_emb.shape)
